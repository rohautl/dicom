<p align="center">
  <img src="https://rohautl.com/assets/img/magnetic-resonance.png" width="125px"/>
  <h3 align="center">dicom</h3>
  <p align="center">High Performance Golang DICOM Medical Image Parser<p>
  <p align="center"> 
    <a href="https://github.com/rohautl/dicom/actions"><img src="https://github.com/rohautl/dicom/workflows/build/badge.svg" /></a> 
    <a href="https://godoc.org/github.com/rohautl/dicom"><img src="https://godoc.org/github.com/rohautl/dicom?status.svg" alt="" /></a>
    <a href="https://goreportcard.com/report/github.com/rohautl/dicom"><img src="https://goreportcard.com/badge/github.com/rohautl/dicom" alt=""></a> 
  </p>
</p>
...
## Usage
To use this in your golang project, import `github.com/rohautl/dicom`. This repository supports Go modules, and regularly tags releases using semantic versioning. Typical usage is straightforward:
```go 
...
fmt.Println(j)
```
More details about the package (and additional examples and APIs) can be found in the [godoc](https://godoc.org/github.com/rohautl/dicom).
...
### Installation
You can download the prebuilt binaries from the [releases tab](https://github.com/rohautl/dicom/releases), or use the following to download the binary at the command line using my [getbin tool](https://github.com/rohautl/getbin):

```sh
wget -qO- "https://getbin.io/rohautl/dicom" | tar xvz
```
